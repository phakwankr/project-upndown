...
const reducer = (state, action) => {
  ...
  if (action.type === GET_ACTIVITY_BEGIN) {
  ...
  if (action.type === SET_EDIT_ACTIVITY) {
    const activity = state.activity.find((activity) => activity._id === action.payload.id);
    const { _id, position, company, activityLocation, activityType, status } = activity;
    return {
      ...state,
      isEditing: true,
      editActivityId: _id,
